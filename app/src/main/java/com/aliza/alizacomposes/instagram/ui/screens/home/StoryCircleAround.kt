...
@Composable
internal fun StoryCircleAround(strokeSize: Dp, sizeStory: Dp, modifier: Modifier = Modifier) {

    val animationParams = remember { StoryAnimationCircleParams() }
...
private fun CoroutineScope.startAnimation(
    ...
    animationParams: StoryAnimationCircleParams
